...
<?php else: ?>
    ...
    <!-- Start of Header section
                        ...
                        <div class="navbar-default">
                            <div class="navbar-header float-left">
                                <a class="navbar-brand text-uppercase" href="<?php echo e(url('/')); ?>">
                                    <img src="https://www.pinclipart.com/picdir/middle/382-3823373_d2s-learning-management-system-learning-management-system-logo.png" alt="logo">
                                </a>
                            </div><!-- /.navbar-header -->
        ...
        <?php echo $__env->make('cookieConsent::index', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
