            ...
            <div class="modal-content">
                ...
                <div class="modal-header backgroud-style">
                    ...
                    <div class="popup-text text-center">
                        <h2><?php echo app('translator')->getFromJson('labels.frontend.modal.my_account'); ?> </h2>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane container active" id="login">
                            ...
                            <form class="contact_form" id="loginForm" action="<?php echo e(route('frontend.auth.login.post')); ?>"
                                ...
                                <a href="#" class="go-register float-left text-info pl-0">
                                    <?php echo app('translator')->getFromJson('labels.frontend.modal.new_user_note'); ?>
                                </a>
                                ...
                                <div class="contact-info mb-2">
                                    ...
                                    <a class="text-info p-0 d-block text-right my-2"
                                       href="<?php echo e(route('frontend.auth.password.reset')); ?>"><?php echo app('translator')->getFromJson('labels.frontend.passwords.forgot_password'); ?></a>
                                ...
                                <div class="nws-button text-center white text-capitalize">
                                    <button type="submit"
                                            value="Submit"><?php echo app('translator')->getFromJson('labels.frontend.modal.login_now'); ?></button>
                                </div>
                            </form>
                        ...
                        <div class="tab-pane container fade" id="register">
                            ...
                            <form id="registerForm" class="contact_form"
                                ...
                                <a href="#"
                                   class="go-login float-right text-info pr-0"><?php echo app('translator')->getFromJson('labels.frontend.modal.already_user_note'); ?></a>
                                <div class="contact-info mb-2">
                                ...
                                <div class="contact-info mb-2 mx-auto w-50 py-4">
                                    <div class="nws-button text-center white text-capitalize">
                                        <button id="registerButton" type="submit"
                                                value="Submit"><?php echo app('translator')->getFromJson('labels.frontend.modal.register_now'); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.success) {
                                ...
                                $('#login').addClass('active').removeClass('fade')
                                $('.success-response').html("<?php echo app('translator')->getFromJson('labels.frontend.modal.registration_message'); ?>");
                            }
                        }
                    });
                });
