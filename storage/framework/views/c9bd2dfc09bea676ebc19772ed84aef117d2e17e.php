...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left"><?php echo app('translator')->getFromJson('labels.backend.courses.create'); ?></h3>
            ...
            <?php if(Auth::user()->isAdmin()): ?>
                <div class="row">
                    <div class="col-10 form-group">
                        ...
                        <?php echo Form::select('teachers[]', $teachers, old('teachers'), ['class' => 'form-control select2 js-example-placeholder-multiple', 'multiple' => 'multiple']); ?>
