    ...
    <section id="breadcrumb" class="breadcrumb-section relative-position backgroud-style">
        ...
        <div class="container">
            <div class="page-breadcrumb-content text-center">
                <div class="page-breadcrumb-title"><h2 class="breadcrumb-head black bold"><span><?php echo app('translator')->getFromJson('http.404.title2'); ?></span></h2></div>
                ...
                <div class="b-not_found w-100">
                    <div class="text-center">
                        <div class="b-page_header">
                            <h1 class="page-title"><?php echo app('translator')->getFromJson('http.404.title'); ?></h1>
                        </div>
                        <h2><b><?php echo app('translator')->getFromJson('http.404.description'); ?></b></h2>
                        <p>
                            <?php echo app('translator')->getFromJson('http.404.description2'); ?>
                        </p>
                        <div class="nws-button genius-btn text-center  d-inline-block gradient-bg text-uppercase">
                            <a href="<?php echo e(url('/')); ?>"><?php echo app('translator')->getFromJson('http.404.back'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
